...
export const metadata = {
  ...
  keywords: "Poovendran S, Full Stack Developer, React, Node.js, MongoDB, Portfolio",
};
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta name="keywords" content="Poovendran S, Full Stack Developer, React, Node.js, MongoDB, Portfolio" />
      </head>
